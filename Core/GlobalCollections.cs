...
public class GlobalCollections {
   ...
   /* public static List<string> LicWords = new List<string>()
    ...
    {
        new Vector3(-423.1714, -190.4851, 37.19953),
        new Vector3(-388.1714, -191.4851, 37.59953),
        new Vector3(-1034.278, -2730.745, 13.75664),
        new Vector3(-1049.063, -2716.557, 13.75664),
    };
   ...
   /* public static Dictionary<string, Vector3> Points = new Dictionary<string, Vector3>()
    {
        ...
        { "Госпиталь", Ems.emsCheckpoints[0] },
        { "ФБР", Fbi.EnterFBI },
        ...
        { "La Cosa Nostra", Manager.FractionSpawns[10] },
        { "Русская мафия", Manager.FractionSpawns[11] },
        { "Yakuza", Manager.FractionSpawns[12] },
        { "Армянская мафия", Manager.FractionSpawns[13] },
    };
